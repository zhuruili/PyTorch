...
def reserve_chinese(content):
    ...
    return content_str
def getStopWords():
    file = open('D:\helloworld_python\LSTM\data\stopwords .txt', 'r',encoding='utf8')
...
def getData(file='D:\helloworld_python\LSTM\data\data.txt',):
...
model.fit(train_seq_mat,train_y,batch_size=128,epochs=10,
    ...
    # 保存模型
model.save('D:\helloworld_python\LSTM\model/LSTM.h5')
del model
## 对验证集进行预测
    # 导入已经训练好的模型
model = load_model('D:\helloworld_python\LSTM\model/LSTM.h5')
